...
<head>
  ...
  <link rel="stylesheet" href="public/css/style4Result.css">
      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
              <ul class="navbar-nav me-3 align-items-center">
                  ...
                  <li class="nav-item fw-bold"><a class="nav-link text-dark" href="index.php?page=test">Test</a></li>
  ...
  <section class="container my-5">
    <div class="row justify-content-center align-items-center">
      <div class="col-md-6 col-lg-6">
        <div class="image-box">
          <img src="public/img/result.png" alt="Great Job" class="img-fluid custom-image">
        </div>
      </div>
      <div class="col-md-6 col-lg-6 m-lg-0">
        ...
        <a href="index.php?page=takingTest" style="color: black;display: inline-block; background-color: #fff8d4; padding: 10px 20px; border-radius: 50px; text-decoration: none; text-align: center; width: 250px;">
            Take Test Again
        </a>

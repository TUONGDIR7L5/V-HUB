...
<head>
  ...
  <link rel="stylesheet" href="public/css/style4TakingTest.css">
...
<body>
  ...
  <div class="container-fluid test-header d-flex justify-content-between align-items-center sticky-top">
    <div class="d-flex align-items-center">
      <img src="public/img/grammar.png" alt="Icon" width="40" class="me-2">
   ...
   <button class="btnQuit">
    <a href="index.php?page=test">Quit Test</a>
  </button>
  ...
  <script src="public/js/script4TakingTest.js"></script>

...
<head>
  ...
  <title>Grammar - Our Courses | VHuB</title>
...
<!-- Header -->
              ...
              <ul class="navbar-nav me-3 align-items-center">
                  ...
                  <li class="nav-item">
                      ...
                      <?php else: ?>
                        ...
                        </a>                          <a href="index.php?page=form" class="btn rounded-pill px-4 py-1" style="background-color: #fff8d4; border: 1px solid #f58e42;">Sign up</a>
                      <?php endif; ?>
                  </li>
              </ul>
          </div>
  ...
  <div class="container py-4">
    <div class="mb-4">
        ...
        <h3><img src="public/img/grammar.png" alt="books" class="me-2"/>Vietnamese Grammar</h3>
    ...
    <div class="row g-4">
        ...
        <div class="container my-5">
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/askQ.png" class="card-img-top" alt="Image 1">
                        <div class="card-body">
                            <h5 class="card-title">Asking Questions</h5>
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/tellingDirect.png" class="card-img-top" alt="Image 2">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/connectSentences.png" class="card-img-top" alt="Image 3">
                        <div class="card-body">
                            <h5 class="card-title">Connecting Sentences</h5>
                            <p class="card-text">Beginer - Vocabulary</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/tense.png" class="card-img-top" alt="Image 4">
                        <div class="card-body">
                            <h5 class="card-title">Tenses</h5>
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/traveling.png" class="card-img-top" alt="Image 5">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/family.png" class="card-img-top" alt="Image 6">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/clock.png" class="card-img-top" alt="Image 3">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/tech.png" class="card-img-top" alt="Image 4">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="public/img/grammar/hobby.png" class="card-img-top" alt="Image 5">
                        <div class="card-body">
